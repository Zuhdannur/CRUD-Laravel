    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <a href="{{ url('/') }}" class="btn bg-purple"><i class="fa fa-chevron-left"></i>Kembali
          </a>
        ...
        <div class="box-body">
          <form class="form-horizontal" action="{{ empty($result) ? url('kelas/add') : url("kelas/$result->id_kelas/edit") }}" method="post">
                {{csrf_field()}}
